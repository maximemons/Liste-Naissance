...
function showTutorialModal(idx) {
	...
	const tutorialSteps = [
  { "text": "Bienvenue sur notre liste de naissance !<br/><br/>Le site permet à nos proches de se coordonner sur les achats.<br>Il ne sert pas à acheter, juste à \"réserver\" des articles.<br/><br/>Bonne visite !", "img": null },
  ...
  { "text": "Tu peux choisir d'en acheter un, plusieurs, ou une partie d'un article (certains articles peuvent être onéreux, d'où l'intérêt de le partager) :", "img": "img/tuto/tuto_6_2.png" },
  ...
  { "text": "Pour rappel, ne te sens pas obligé de quoi que ce soit !<br/>Ta seule présence dans la vie de Johanne est déjà le plus beau des cadeaux ❤️", "img": null }
];
